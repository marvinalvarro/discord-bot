...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("panduan")
        .setDescription("Tampilkan buku panduan warga Game Verse"),
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                `> <#${1526127278621200456}>: Baca dulu sebelum aktif, biar nggak kena banned.\n` +
                ...
                `> **Respect the Staff**: Kalau ditegur Moderator atau Admin, tolong diturutin ya biar tongkrongan tetep asik.\n\n` +
